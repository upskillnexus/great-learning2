      ...
      <Flex gap={["40px", "20px", "20px", "20px"]} flexDirection={{ base: "column", md: "row", lg: "row" }} justifyContent={"space-around"}>
        ...
        <Flex mt={10} paddingX={{ base: "15px", sm: "15px", md: "10px", lg: "5px" }} flexDirection={"column"} w={["auto", "auto", "600px"]}>
          ...
          <Text
            ...
            // fontWeight={600}
          >
            Our mission at UpskillNexus is to be the beacon of transformation in the realm of digital technology and employability skills training. We are committed to cultivating a dynamic learning environment where individuals, regardless of their background or current career stage, can acquire the essential digital technological skills and employability skills, strategic insights, and unwavering confidence needed to not only secure employment but to thrive and excel in their chosen professional journeys.
          </Text>
          {/* <Button
          mt={5}
          rounded={"4"}
