...
import { Box, Button, ChakraProvider, FormControl, FormLabel, Input, Stack, Heading, Spinner } from "@chakra-ui/react";
      ...
      <Box display="flex" alignItems="center" justifyContent="center" h="100vh" bg="#bd2c22">
        <Box p={8} maxW="600px" w="550px" borderWidth={1} rounded={8} boxShadow="lg" bg="white">
          <Stack spacing={4}>
            ...
            <Button onClick={!loading && !success && handleSubmit(onSUbmit)} type="submit" colorScheme="red" bg="#bd2c22" _hover={{ bg: "#ab241b" }}>
