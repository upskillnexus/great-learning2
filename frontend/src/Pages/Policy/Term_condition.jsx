...
const Term_condition = () => {
  const termsData = [
    ...
    },
    {
      ...
      content: [
        "Course Fees: Some of our courses and services may require payment. Fees for courses are as described on the website. Payment is processed through trusted third-party payment providers.",
        "Refund Policy: Our refund policy, if applicable, is outlined on our website. Please review it carefully before making a payment.",
      ],
    },
    {
    ...
    <>
      <Flex p="5" gap={5} flexDir={"column"} align="center">
        ...
        <Text w={{ base: "full", md: "50%" }} textAlign={"center"}>
          Welcome to <GetUpskillnexus text="UpskillNexus" />! These Terms and Conditions govern your use of our website, courses, and services. By accessing or using our website and services, you agree to be bound by these Terms.
        </Text>
