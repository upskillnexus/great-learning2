...
const programs = [
...

  {
    ...
    para: "This comprehensive course focuses on building a sound foundation in soft skills required to complement technical skills to succeed in today's competitive job market.",
...

  {
    ...
    para: "Tailored for professionals at the mid-career stage, this course goes beyond the basics to excel in leadership roles.",
    duration: "12 Months • Offline (In-Class Training)",
    badge: "DEDICATED CAREER SUPPORT",
    link: "cyber-security",
  },
            ...
            <VisibilitySensor key={index} partialVisibility>
              {({ isVisible }) => (
                ...
                >
                  ...
                  <Text>{ele.para.substring(0, 110)}...</Text>
                  <Button
                    onClick={() => onOpen()}
                    bg="#b9292f"
                    color="white"
                    _hover={{ bg: "none", color: "#b9292f", border: "1px solid #b9292f" }}
                  >
                    Talk To Advisor
                  </Button>
                </MotionBox>
