  ...
  return (
    <Flex justify={'center'} align="center" width={{ base: "full", md: "90%" }} mx="auto">
      <Flex flexDir={"column"} align={"center"} gap="5" p={{ base: 0, md: "10px" }}>
        ...
        {/*  */}
        <Grid p={'3'} w='full' gridTemplateColumns={{lg:'repeat(5,1fr)', md: 'repeat(3,1fr)', sm: 'repeat(2,1fr)', base: 'repeat(1,1fr)'}} placeItems={'center'} gap={{ base: "20px", md: "3" }} border="3px solid none">
          {data?.map((ele, i) => (
